...
private _moduleVarName = "JC_Mod_FrontLandingDeck";
...
private _composition = [
    ["Land_CampingTable_F", [2.5, -5.75, 0.31], [[0,1,0],[0,0,1]], "SCENERY", ""],
    ["Land_Laptop_unfolded_F", [2.5, -5.75, 0.95], [[0,-1,0],[0,0,1]], "TELEPORTER", ""]
